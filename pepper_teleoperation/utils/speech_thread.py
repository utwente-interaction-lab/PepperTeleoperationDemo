...
class SpeechThread(Thread):
    ...
    def run(self):
        ...
        try:
            ...
            print("SpeechThread microphone unavailable: %s" % e)
    ...
    def recognize(self):
        ...
        try:
            mic_ctx = sr.Microphone(device_index=1)
        except Exception as e:
            print("SpeechThread microphone init failed: %s" % e)
            self.mic_available = False
            return None
        ...
        with mic_ctx as source:  
            ...
            try:
                ...
                print("SpeechThread backend unavailable: %s" % e)
                self.mic_available = False
                return None
